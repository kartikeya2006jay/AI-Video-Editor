...
export default function Home() {
  ...
  const [activeSettingsTab, setActiveSettingsTab] = useState<'style' | 'layout' | 'effects'>('style')
  ...
  const applyStyleToAll = () => {
    alert("Style applied to all captions in final output!")
  }
    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 group cursor-pointer">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white flex items-center gap-2">
                  <span className="gradient-text">AI Video Caption Studio</span>
                ...
                <p className="text-sm text-gray-400 flex items-center gap-2">
                  <span className="flex items-center gap-1">
                    ...
                    Final output captions with styles
                  </span>
                </p>
              </div>
            </div>
      ...
      <div className="container mx-auto px-8 py-8 animate-fade-in">
        <div className="grid grid-cols-12 gap-8">
          {/* Left Panel - Caption Customization */}
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700/50 p-6 hover-lift transition-all duration-300 hover:border-purple-500/30">
              ...
              <div className="flex gap-2 mb-6 bg-gray-700/30 rounded-xl p-1">
                <button
                  ...
                  className={`flex-1 py-2 px-4 rounded-lg text-sm font-medium transition-all ${activeSettingsTab === 'style' ? 'bg-gradient-to-r from-blue-500/20 to-purple-500/20 text-blue-400 border border-blue-500/30' : 'text-gray-400 hover:text-white'}`}
                >
                  Text Style
                </button>
                <button
                  onClick={() => setActiveSettingsTab('layout')}
                  className={`flex-1 py-2 px-4 rounded-lg text-sm font-medium transition-all ${activeSettingsTab === 'layout' ? 'bg-gradient-to-r from-blue-500/20 to-purple-500/20 text-blue-400 border border-blue-500/30' : 'text-gray-400 hover:text-white'}`}
                >
                  Layout
                </button>
                <button
                  onClick={() => setActiveSettingsTab('effects')}
                  className={`flex-1 py-2 px-4 rounded-lg text-sm font-medium transition-all ${activeSettingsTab === 'effects' ? 'bg-gradient-to-r from-blue-500/20 to-purple-500/20 text-blue-400 border border-blue-500/30' : 'text-gray-400 hover:text-white'}`}
                >
                  Effects
                </button>
              </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between">
                            <label className="text-sm font-medium text-white">Margin</label>
                            <span className="text-sm text-gray-400">{themeSettings.captions.margin}px</span>
                          </div>
                          <input
                            type="range"
                            min="0"
                            max="40"
                            value={themeSettings.captions.margin}
                            onChange={(e) => updateCaptionSetting('margin', parseInt(e.target.value))}
                            className="w-full h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer progress-gradient"
                          />
                        </div>
                      </div>
                ...
                {currentSubtitle && (
                  <div className="bg-gray-800/30 rounded-xl p-4 animate-fade-in hover-lift transition-all duration-300">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm text-gray-400 mb-1">Active Caption • Applies to final video</p>
                        ...
                        <p className="text-xs text-gray-500 flex items-center gap-2">
                          ...
                          <span className="text-gray-600">•</span>
                          <span className="text-green-400">✓ Styles baked into output</span>
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-4 gap-4">
                    ...
                    <div className="bg-gray-700/30 rounded-xl p-4 hover-lift transition-all duration-300 group">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm text-gray-400 group-hover:text-orange-400 transition-colors">Effects</p>
                          <p className="text-lg font-semibold text-white">
                            {themeSettings.captions.borderWidth > 0 ? 'Border' : 'No Border'}
                          </p>
                        </div>
                      </div>
                    </div>
        ...
        <div className="container mx-auto px-8 py-3">
          <div className="flex items-center justify-between text-sm">
            ...
            <div className="flex items-center gap-4 text-gray-400">
              ...
              <div className="text-gray-500">|</div>
              <span className="text-blue-400">All styles applied to video</span>
            </div>
          </div>
        </div>
      </div>
